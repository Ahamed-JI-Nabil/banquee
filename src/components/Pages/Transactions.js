            ...
            <div className=''>
                <div className="mockup-phone border-none">
                    ...
                    <div className="display">
                        <div className="artboard-demo w-[330px] h-[620px] pl-4 justify-start pt-12 phone-1 text-black">
                            ...
                            <div className='flex text-lg mt-4'>
                                ...
                                <p className='text-accent pr-8'>View all <i className="fa-solid fa-arrow-right"></i></p>
                            </div>
                            <div className='w-80 h-16 px-5 mb-2'>
                                <div className='flex flex-row justify-between items-center  bg-[#F8F8F8] p-3 rounded-md mr-6'>
                                    <i className="fa-brands fa-apple w-8 h-8 rounded-md bg-accent text-slate-50 p-2"></i>
